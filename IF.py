...
temperatura = 30  # Exemplo de valor, substitua com input do usuário se necessário
...
# com severidade 'ERROR'. Dado um registro de log em formato de dicionário como 
...
# e tenha fornecido um email válido. Escreva um programa que valide essas condições 
# e imprima "Dados de usuário válidos" ou o erro específico encontrado.

idade = 19  # Exemplo de valor, substitua com input do usuário se necessário
